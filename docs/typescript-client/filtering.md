...
The same filtering syntax can be used in the in multiple places, including the [Query API](/typescript-client/get), the [Search API](/typescript-client/search), and the [Aggregate API](/typescript-client/aggregate). By using the same syntax, you can more easily switch between the APIs that you need.
